...
@NgModule({
  imports: [
    RouterModule.forChild([
      { path: "info", component: ServerConfigComponent },
      { path: "loggers", component: LoggersComponent },
      { path: "loggers/create", component: LoggerCreateComponent },
      { path: "loggers/edit/:id", component: LoggerEditComponent },
      { path: "httptasks", component: HttpTasksComponent },
      { path: "httptasks/edit/:id", component: HttpTaskEditComponent },
      { path: "httptasks/create", component: HttpTaskCreateComponent },
